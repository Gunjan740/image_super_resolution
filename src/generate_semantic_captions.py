...
IMAGE_DIR = os.path.expanduser("~/datasets/DF2K/DF2K_LR_x4")
OUT_DIR = os.path.expanduser("~/datasets/DF2K/captions_chunks_LR_x4_semantic")

NUM_CHUNKS = 20  # adjust if needed (higher = smaller chunks)
